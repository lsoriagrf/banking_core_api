package com.lisdev.customersapi.infrastructure.web.controller;
...
import com.lisdev.customersapi.infrastructure.web.mapper.CustomerWebMapper;
...
public class CustomerController {
    ...
    public Mono<ResponseEntity<CustomerResponse>> updateCustomer(
        ...
        return customerPortIn.updateCustomer(customerWebMapper.toUpdateCommand(id, body))
                .map(customerWebMapper::toResponse)
